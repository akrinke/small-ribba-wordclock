...
.set	BootBaudrate		= 9600	; only used if no Baudrate detection activated, XTAL is than important
.set	BootVersion			= 6			; Version 6 (must be not changed)
.set	BootCodeSize		= 482		; set to 0, compile and set to value in [.cseg] Used, compile again
...
BootSign:	.db		"WCMB"											; iff you change it then change sign in AVRootloader.ini
